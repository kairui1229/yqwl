...
//登录接口
Mock.mock('https://www.ouyangkairui.com/login', 'post', (options: any) => {
...
//echart图表 折线图
Mock.mock('https://www.ouyangkairui.com/chartData', 'get', () => {
  return{
    code: 200,
    message: '请求成功',
    data: {
      list:[
        ...
        {name:"充电功率",data:[30,40,60,50,75,20,30,40,60]}
      ]
    }
  }
})
...
//echart图表 饼图
Mock.mock('https://www.ouyangkairui.com/chartData2', 'get', () => {
  return{
    code: 200,
    message: '请求成功',
    data: {
...
//echart图表 雷达图
Mock.mock('https://www.ouyangkairui.com/chartData3', 'get', () => {
  return{
    code: 200,
    message: '请求成功',
    data: {
      list:[42,120,200,340,150,230]
    }
  }
})
...
// 定义 API 接口
Mock.mock("https://www.ouyangkairui.com/stationList", 'post', (options: any) => {
  chargingStation = originalChargingStation
  const { id, name, status, page, pageSize } = options.body ? JSON.parse(options.body) : {}
  // 根据条件过滤数据
  if (id) {
    chargingStation = chargingStation.filter(item => item.id.includes(id));
  }
  if (name) {
...
//新增/编辑充电站
Mock.mock("https://www.ouyangkairui.com/station/edit", 'post', (options: any) => {
...
//删除充电站接口
Mock.mock("https://www.ouyangkairui.com/station/delete", "post", (options: any) => {
  console.log("删除充电站接口收到参数", options.body)
  return {
    code: 200,
    success: true,
    data: "操作成功",
...
//营收统计图表
Mock.mock("https://www.ouyangkairui.com/revenueChart", "get", () => {
  return {
    code: 200,
    success: true,
    data: {
...
// 定义 API 接口
Mock.mock("https://www.ouyangkairui.com/revenueList", 'post', (options: any) => {
...
let chargingPile = [
  {
    ...
    list: [
      ...
      { id: "CD1002", voltage: "314v", current: "212.2A", power: "21KW", tem: "29°c", status: 2, percent: "68%" },
      ...
      { id: "CD1005", voltage: "314v", current: "212.2A", power: "21KW", tem: "30°c", status: 2, percent: "56%" },
      { id: "CD1006", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 2, percent: "34%" },
      ...
      { id: "CD1016", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 2, percent: "24%" },
  ...
  },
  {
    ...
    list: [
      ...
      { id: "CD1002", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 6, percent: "56%" },
      { id: "CD1003", voltage: "314v", current: "212.2A", power: "21KW", tem: "27°c", status: 6 },
      { id: "CD1004", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 5, percent: "23%" },
      { id: "CD1005", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 4, percent: "12%" },
      ...
      { id: "CD1008", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 2, percent: "99%" },
  ...
  },
  {
    ...
    list: [
      ...
      { id: "CD1002", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 2, percent: "100%" },
      { id: "CD1003", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 3 },
      { id: "CD1004", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 2, percent: "34%" },
      { id: "CD1005", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 1, percent: "75%" },
      { id: "CD1006", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 2, percent: "45%" },
      { id: "CD1007", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 6 },
      { id: "CD1008", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 3, percent: "13%" },
      { id: "CD1009", voltage: "314v", current: "212.2A", power: "21KW", tem: "32°c", status: 1 },
...
//充电桩列表接口
Mock.mock("https://www.ouyangkairui.com/currentList", "post", () => {
  return {
    code: 200,
    success: true,
    data: chargingPile
...
//电子地图接口
Mock.mock("https://www.ouyangkairui.com/mapList", "post", () => {
  return {
    code: 200,
    success: true,
    data: stations
...
//订单管理接口
Mock.mock('https://www.ouyangkairui.com/orderList', 'post', (options: any) => {
    ...
    data: Mock.mock({
      [`list|${pageSize}`]: [{
        ...
        'date': function() {
          ...
          return Mock.mock(`@date("MM-dd")`).replace(/^/, `${year}-`);
        }, // 订单日期 (随机 2023、2024 或 2025 年)
        'startTime': '@time("HH:mm:ss")', // 开始时间 (随机时间)
        'endTime': '@time("HH:mm:ss")', // 结束时间 (随机时间)
        "equipmentNo": '@character("upper")@natural(100,999)', // 设备编号 (随机字母+三位数字)
        'money': '@float(10, 1000, 1, 1)', // 金额 (10-1000 随机小数, 保留 1 位)
        'pay|1': ["微信", "支付宝", "银行卡", "花呗"], // 支付方式
        'status|1': [2, 3, 4] // 订单状态
      }],
      "total": 54
    })
...
//订单管理-批量删除接口
Mock.mock('https://www.ouyangkairui.com/batchDelete', "post", (options: any) => {
...
//计费管理城市接口
Mock.mock('https://www.ouyangkairui.com/cityList', "get", () => {
  return {
    code: 200,
    message: "操作成功",
    data: cityList
...
Mock.mock('https://www.ouyangkairui.com/alarmList', "get", () => {
  return {
    code: 200,
    message: "操作成功",
    data: alarmList
...
//会员卡管理接口
Mock.mock('https://www.ouyangkairui.com/member', 'post', (req:any) => {
...
//招商管理分类列表接口
Mock.mock('https://www.ouyangkairui.com/document',"get",()=>{
  return {
    code:200,
    message:"操作成功",
    data:{
...
Mock.Random.extend({
  account: function() {
    ...
    const length = Mock.mock('@natural(6, 9)');
    let result = '';
...
//权限设置页面
Mock.mock('https://www.ouyangkairui.com/permissionList','post',(req:any)=>{
...
return {
    ...
    data:Mock.mock({
      [`list|${pageSize}`]:[{
        ...
        "pageAuthority|1":['管理员','经理','用户'],//页面权限
        'btnAuthority|1':['添加','删除','编辑','全部'],//按钮权限
    }],
    total:41
    })
  }
...
//获取当前用户权限
Mock.mock("https://www.ouyangkairui.com/userAuth","post",(req:any)=>{
 //console.log(234,req.body)
 const {pageAuthority,btnAuthority}=JSON.parse(req.body)
  console.log("后端收到当前权限",pageAuthority)
  return {
    code:200,
    message:"操作成功",
    data:{
      list:pageAuthority=="用户"? userMenulist:(pageAuthority=="经理"?menulist2:menulist),
      btn:btnAuthority=="添加"?['add']:(btnAuthority=="编辑"?["edit"]:(btnAuthority=="删除"?["delete"]:["add","edit","delete"]))
    }
  }
})

//权限设置接口
Mock.mock("https://www.ouyangkairui.com/setAuth","post",(req:any)=>{
  const {btnList,pageList,account}=JSON.parse(req.body)
  console.log("权限设置接口修改账号权限",account,pageList,btnList)
  return{
    code:200,
    message:"操作成功",
    data:null
